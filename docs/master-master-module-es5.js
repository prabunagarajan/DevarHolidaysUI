...
var routes = [
    {
        path: 'driver-detail',
        loadChildren: function () { return Promise.all(/*! import() | driver-details-driver-details-module */[__webpack_require__.e("common"), __webpack_require__.e("driver-details-driver-details-module")]).then(__webpack_require__.bind(null, /*! ./driver-details/driver-details.module */ "./src/app/master/driver-details/driver-details.module.ts")).then(function (module) { return module.DriverDetailsModule; }); }
    },
    {
        path: 'vehicle-detail',
        loadChildren: function () { return Promise.all(/*! import() | vehicle-details-vehicle-details-module */[__webpack_require__.e("default~trip-details-at-trip-details-at-module~trip-details-trip-details-trip-details-module~vehicle~e5f14595"), __webpack_require__.e("common"), __webpack_require__.e("vehicle-details-vehicle-details-module")]).then(__webpack_require__.bind(null, /*! ./vehicle-details/vehicle-details.module */ "./src/app/master/vehicle-details/vehicle-details.module.ts")).then(function (module) { return module.VehicleDetailsModule; }); }
    }
];
