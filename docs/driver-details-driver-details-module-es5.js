...
var DriverDetailsComponent = /** @class */ (function () {
    function DriverDetailsComponent(router, masterService, toastrMsg, formBuilder) {
        ...
        this.columns = src_app_config_master_list_columns__WEBPACK_IMPORTED_MODULE_11__["MasterListColumns"].driverDetailListColumns;
    ...
    DriverDetailsComponent.prototype.generatePDF = function () {
        ...
        var columns = ['S.No', 'Name', 'Mobile Number', 'Driving License Number', 'Aadhar Number', 'District'];
        var data = [];
    ...
    DriverDetailsComponent.prototype.exportToExcel = function () {
        var rows = [];
        this.dataSource.data.forEach(function (element, i) {
            rows[i] = [];
            rows[i].push(i + 1);
        ...
        var options = {
            headers: [
                'S.No', 'Name', 'Mobile Number', 'Driving License Number', 'Aadhar Number', 'District'
            ]
        };
        new ngx_csv__WEBPACK_IMPORTED_MODULE_10__["ngxCsv"](rows, 'Driver_Details', options);
    };
