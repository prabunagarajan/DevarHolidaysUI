...
let BasicTypographyRoutingModule = class BasicTypographyRoutingModule {
};
...
let BasicTypographyComponent = class BasicTypographyComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let BasicTypographyModule = class BasicTypographyModule {
};
