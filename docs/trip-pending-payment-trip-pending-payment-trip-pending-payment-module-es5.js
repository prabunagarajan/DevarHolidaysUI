...
var TripPendingPaymentComponent = /** @class */ (function () {
    function TripPendingPaymentComponent(formBuilder, commonService, router) {
    ...
    TripPendingPaymentComponent.prototype.getTripPaymentPendingList = function (pageIndex, pageSize) {
        ...
        this.commonService.getTripPaymentPendingList().subscribe(function (response) {
            ...
            if (response.status == 's' && response.data) {
                _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](response.data);
    ...
    TripPendingPaymentComponent.prototype.onSelect = function (viewObj) {
