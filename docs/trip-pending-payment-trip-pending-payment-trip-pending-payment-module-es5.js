...
var TripPendingPaymentEditComponent = /** @class */ (function () {
    function TripPendingPaymentEditComponent(formBuilder, toastrMsg, commonService, router, activatedRoute) {
    ...
    TripPendingPaymentEditComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    TripPendingPaymentEditComponent.prototype.calculateTotalHours = function () {
    ...
    Object.defineProperty(TripPendingPaymentEditComponent.prototype, "tripForm", {
        get: function () {
    ...
    TripPendingPaymentEditComponent.prototype.submit = function (tripFormDetails, level) {
        var _this = this;
    ...
    TripPendingPaymentEditComponent.prototype.acDetect = function (event) {
        if (event === 'Non-AC') {
    ...
    TripPendingPaymentEditComponent.prototype.finalSubmit = function () {
    ...
    TripPendingPaymentEditComponent.prototype.forwardApprove = function () {
        var _this = this;
        this.btnLoder = true;
    ...
    TripPendingPaymentEditComponent.prototype.approved = function () {
        var _this = this;
        this.btnLoder = true;
        this.commonService.getTripDetailsForward({
            id: this.tripId,
    ...
    TripPendingPaymentEditComponent.prototype.requestForClarification = function () {
        var _this = this;
        this.btnLoder = true;
        this.commonService.getTripDetailsForward({
            id: this.tripId,
    ...
    TripPendingPaymentEditComponent.prototype.addTripDetails = function () {
        var _this = this;
    ...
    TripPendingPaymentEditComponent.prototype.startingKM = function (startingKMElemant) {
    ...
    TripPendingPaymentEditComponent.prototype.closeingKM = function (closingKMElemant) {
        if (closingKMElemant) {
            if (this.tripFormDetails.controls.closingKM.value) {
    ...
    TripPendingPaymentEditComponent.prototype.numbersOnly = function (event) {
    ...
    TripPendingPaymentEditComponent.prototype.getReceivedAmount = function (receivedAmount) {
    ...
    TripPendingPaymentEditComponent.prototype.getTotalRentAmount = function (totalRentAmount) {
        var advanceAmount = this.tripFormDetails.controls.advanceAmount.value ? parseFloat(this.tripFormDetails.controls.advanceAmount.value) : 0;
    ...
    TripPendingPaymentEditComponent.prototype.getAdvanceAmount = function (advanceAmount) {
        var totalRentAmount = this.tripFormDetails.controls.totalRent.value ? parseFloat(this.tripFormDetails.controls.totalRent.value) : 0;
        var receivedAmount = this.tripFormDetails.controls.receivedAmount.value ? parseFloat(this.tripFormDetails.controls.receivedAmount.value) : 0;
    ...
    TripPendingPaymentEditComponent.prototype.getStaringKM = function (statingKM) {
        var _this = this;
    ...
    TripPendingPaymentEditComponent.prototype.acStaringKmCalculation = function (startingKM) {
        // formula <==> ("u = c - s")
    ...
    TripPendingPaymentEditComponent.prototype.acClosingKmCalculation = function (closingKM) {
        // formula <==> ("u = c - s")
    ...
    TripPendingPaymentEditComponent.prototype.profitAmoutCalculation = function (string) {
    ...
    TripPendingPaymentEditComponent.prototype.updateTripDetails = function () {
        var _this = this;
        var tripFormDetails = this.tripFormDetails.value;
        ...
        this.commonService.tripDetailModification(updateTripDetailsRequest).subscribe(function (updateTripDetailsResponse) {
            ...
            if (updateTripDetailsResponse.status = 's') {
                _this.submitPopUp.hide();
                _this.toastrMsg.success("Pending Payment details modified successfully");
                _this.router.navigate(['/container/trip-payment-pending/list']);
            }
            else {
    ...
    TripPendingPaymentEditComponent.prototype.getTripDetailsForm = function (tripId) {
        var _this = this;
        this.commonService.getTripDetails(tripId).subscribe(function (getTripDetailsResponse) {
            if (getTripDetailsResponse.status == 's') {
                ...
                console.log(_this.getTripDetails);
    ...
    TripPendingPaymentEditComponent.prototype.back = function () {
        this.router.navigate(['/container/trip-payment-pending/list']);
    };
    TripPendingPaymentEditComponent.ctorParameters = function () { return [
    ...
    return TripPendingPaymentEditComponent;
}());
...
var TripPendingPaymentRoutingModule = /** @class */ (function () {
    function TripPendingPaymentRoutingModule() {
    }
    ...
    return TripPendingPaymentRoutingModule;
}());
...
var TripPendingPaymentViewComponent = /** @class */ (function () {
    function TripPendingPaymentViewComponent(commonService, activatedRoute, router) {
        this.commonService = commonService;
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.tripLogDetails = [];
    }
    TripPendingPaymentViewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.activatedRoute.params.subscribe(function (tripIdResponse) {
            if (tripIdResponse.id) {
    ...
    TripPendingPaymentViewComponent.prototype.back = function () {
        this.router.navigate(['/container/trip-payment-pending/list']);
    };
    TripPendingPaymentViewComponent.ctorParameters = function () { return [
    ...
    return TripPendingPaymentViewComponent;
}());
...
var TripPendingPaymentComponent = /** @class */ (function () {
    function TripPendingPaymentComponent(formBuilder, commonService, router, toastrMsg) {
        this.formBuilder = formBuilder;
        this.commonService = commonService;
        this.router = router;
        this.toastrMsg = toastrMsg;
    ...
    TripPendingPaymentComponent.prototype.ngOnInit = function () {
        this.getTripPaymentPendingList();
    };
    TripPendingPaymentComponent.prototype.getTripPaymentPendingList = function (pageIndex, pageSize) {
        var _this = this;
        if (pageIndex === void 0) { pageIndex = 0; }
        if (pageSize === void 0) { pageSize = this.pageSize; }
        this.isLoading = true;
        this.commonService.getTripPaymentPendingList().subscribe(function (response) {
            ...
            if (response.status == 's' && response.data) {
                ...
                _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](dataSource);
    ...
    TripPendingPaymentComponent.prototype.onChecked = function (element) {
    ...
    TripPendingPaymentComponent.prototype.onEdit = function () {
        if (this.selectObj) {
    ...
    TripPendingPaymentComponent.prototype.onView = function () {
        if (this.selectObj) {
    ...
    TripPendingPaymentComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    ...
    return TripPendingPaymentComponent;
}());
...
var TripPendingPaymentModule = /** @class */ (function () {
    function TripPendingPaymentModule() {
    }
    ...
    return TripPendingPaymentModule;
}());
...
//# sourceMappingURL=trip-pending-payment-trip-pending-payment-trip-pending-payment-module-es5.js.map