...
var BasicSpinnerRoutingModule = /** @class */ (function () {
    function BasicSpinnerRoutingModule() {
    }
...
var BasicSpinnerComponent = /** @class */ (function () {
    ...
    BasicSpinnerComponent.prototype.onBtnLoader = function () {
        var _this = this;
        this.btnLoader = true;
        setTimeout(function () {
    ...
    BasicSpinnerComponent.prototype.onSubmitLoader = function () {
        var _this = this;
...
var BasicSpinnerModule = /** @class */ (function () {
    function BasicSpinnerModule() {
    }
