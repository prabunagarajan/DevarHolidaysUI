...
var VehicleDetailsComponent = /** @class */ (function () {
    ...
    VehicleDetailsComponent.prototype.loadDriverDetails = function (pageIndex, pageSize) {
        ...
        this.masterService.vehicleDetailsGetAllList(request).subscribe(function (res) {
            if (res.status === 's') {
                _this.dataSource.data = res.data.contents;
    ...
    VehicleDetailsComponent.prototype.selectRecord = function (record) {
    ...
    VehicleDetailsComponent.prototype.pageEvent = function (event) {
    ...
    VehicleDetailsComponent.prototype.search = function () {
        ...
        this.masterService.vehicleDetailsGetAllList(searchRequest).subscribe(function (searchResponse) {
            if (searchResponse.status === 's') {
                _this.dataSource.data = searchResponse.data.contents;
                _this.totalCounts = searchResponse.data.totalElements;
            }
            else {
                _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"]();
            }
    ...
    VehicleDetailsComponent.prototype.onclear = function () {
        ...
        this.masterService.vehicleDetailsGetAllList(clearRequest).subscribe(function (clearResponse) {
            if (clearResponse.status === 's') {
                _this.dataSource.data = clearResponse.data.contents;
                _this.totalCounts = clearResponse.data.totalElements;
            }
            else {
                _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"]();
            }
