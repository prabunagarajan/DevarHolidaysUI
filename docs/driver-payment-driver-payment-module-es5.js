...
var DriverPaymentComponent = /** @class */ (function () {
    ...
    DriverPaymentComponent.prototype.getSaleryDetails = function (pageIndex, pageSize) {
        ...
        this.commonService.driverPaymentList(request).subscribe(function (response) {
            ...
            if (response.status == 's' && response.data) {
                _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableDataSource"](response.data.contents);
    ...
    DriverPaymentComponent.prototype.onSelect = function (viewObj) {
        if (viewObj) {
            this.selectObj = viewObj;
            this.viewEnable = true;
        }
    };
    DriverPaymentComponent.prototype.pageEvent = function (event) {
