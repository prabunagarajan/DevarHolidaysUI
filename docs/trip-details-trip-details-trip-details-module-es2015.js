...
let TripDetailsComponent = class TripDetailsComponent {
    constructor(formBuilder, commonService, router, toastrMsg) {
        ...
        this.maxDate = moment__WEBPACK_IMPORTED_MODULE_10__();
    }
    ngOnInit() {
