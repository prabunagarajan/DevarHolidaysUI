...
var TripDetailsAtComponent = /** @class */ (function () {
    function TripDetailsAtComponent(commonService) {
    ...
    TripDetailsAtComponent.prototype.ngOnInit = function () {
        ...
        this.commonService.tripDetailsSearchList(request).subscribe(function (response) {
            if (response.status == 's' && response.data) {
                _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](response.data.contents);
    ...
    TripDetailsAtComponent.prototype.handlePagination = function (event) {
        console.log('Pagination event:', event);
    };
    TripDetailsAtComponent.prototype.onChecked = function (event) {
        console.log('Checkbox event:', event);
    };
    TripDetailsAtComponent.ctorParameters = function () { return [
